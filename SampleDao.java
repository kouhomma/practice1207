...
public class SampleDao {
	...
	public void insertDb(EntForm entform) {
		db.update("INSERT INTO sample (name1,age,com) VALUES(?,?,?)", entform.getName1(), entform.getAge(),entform.getCom());
	}
	...
	public List<EntForm> searchDb() {
		...
		for (Map<String, Object> result1 : resultDb1) {
			...
			entformdb.setName1((String) result1.get("name1"));
			entformdb.setAge((int) result1.get("age"));
			entformdb.setCom((String) result1.get("com"));
	...
	public void updateDb(Long id, EntForm entform) {
		...
		//UPDATEを実行
		db.update("UPDATE sample SET (name1,age,com)=(?,?,?) WHERE id = ?", entform.getName1(), entform.getAge(),entform.getCom(), id);
